...
class HeatingEnergyASHP(SupplySystemBase):
    """
    """
    def calc_loads(self):
        system = SupplyOut()
        system.fossils_in = self.load / 2.3
        system.electricity_in = 0
        system.electricity_out = 0
        return system


class HeatingEnergyGSHP(SupplySystemBase):
    """
    """
    def calc_loads(self):
        system = SupplyOut()
        system.fossils_in = self.load / 3.67
        system.electricity_in = 0
        system.electricity_out = 0
        return system


class HeatingEnergyPellet(SupplySystemBase):
    """
    """
